...
public class DataOutput2 extends OutputStream implements DataOutput{
    ...
    private static final ThreadLocal<BufferContainer> buffers = new ThreadLocal<BufferContainer>() {
        @Override
        protected BufferContainer initialValue() {
            return new BufferContainer();
        }

        @Override
        public BufferContainer get() {
            return super.get();
        }
    };
